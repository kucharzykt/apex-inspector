		...
		try {
			...
			for (var i = 0; i < regions.length; i++) {
				...
				rowcountbtn.onclick = function() {
					...
					console.log('______clicked');
					console.log('createDiv');
					let div = document.createElement('div');
					console.log($(`#${'popupId'+pi_region.static_id}`).length);
					if ($(`#${'popupId'+pi_region.static_id}`).length > 0) {
						console.log('mazu inner');
						var elem = document.getElementById(`${'popupId'+pi_region.static_id}`);
